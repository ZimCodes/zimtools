...
import styles from '../../styles/zcurl/titlebar.module.css';
...
export default (props) => (
	<nav>
		...
		<h1 className={`${styles.h1} text-center text-white font-weight-bolder pb-1`}>zCurl ~> <span className={styles.span}>_</span> </h1>
	</nav>
);
