...
import styles from '../../styles/zeiver/url.module.css';
export default (props)=>(
    <section className="text-center">
        ...
        <div className="py-4">
            <input className="rounded shadow-sm w-50" placeholder="https://example.com http://000.000.000.000" type="url" onChange={props.getURL}/>
        </div>
        <hr/>
    </section>
