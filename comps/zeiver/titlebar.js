...
import styles from '../../styles/zeiver/titlebar.module.css';
...
export default (props) => (
	<nav className={"mx-auto"}>
		<div className={`${styles.header} row`}>
			...
			<h1 className={`${styles.h1} col text-center font-weight-bolder pb-1`}>Zeiver ~> <span className={styles.span}>_</span> </h1>
		</div>
	</nav>
);
