import styles from '../../styles/ztube-dl/topbar.module.css';
...
export default (props) => (
    <nav className={'mx-auto'}>
        <div className={'bg-danger pb-1 row'}>
            ...
            <h1 className={`${styles.h1} col text-center text-white font-weight-bolder`}>ZTube-dl@Codes ~> <span className={styles.span}>_</span> </h1>
        </div>
    </nav>
);
