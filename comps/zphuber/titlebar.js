...
import styles from '../../styles/zphuber/titlebar.module.css';
...
export default (props) => (
	<nav className={'mx-auto'}>
		<div className={'bg-secondary row'}>
			...
			<h1 className={`${styles.h1} col text-center text-warning font-weight-bolder`}>zPhuber ~> <span className={styles.span}>_</span> </h1>
		</div>
	</nav>
);
